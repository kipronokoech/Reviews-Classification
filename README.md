...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;\mathtext{F}_1= 2 \frac{\text{precision}\times\text{recall}}{\text{precision}+\text{recall}}" title="\Large x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}" />
